    ...
    Autocomplete.prototype = {
        ...
        constructor: Autocomplete, processObj: 0, formatItem: function (item) {
            ...
            var pos = $.extend({}, this.$element.position(), {
                ...
                minWidth: parseInt(this.$element.width()) + parseInt(this.$element.css('padding-left').replace('px', '')) + parseInt(this.$element.css('padding-right').replace('px', ''))
            })
            ...
            items = $(items).map(function (i, item) {
                i = $(that.options.item).attr(that.setValue(item)).css({paddingTop: "5px", paddingBottom: "5px"})
...
//            items.first().addClass('active')
    ...
    $.fn.autocomplete.defaults = {
        source: [], items: 10, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', minLength: 1, delay: 500
    }
